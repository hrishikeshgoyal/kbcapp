...
namespace PhoneApp6
{
    public partial class multiply : PhoneApplicationPage
    {
        static int a1, a2, a3, b1, b2, b3, b4;
        public multiply()
        {
            InitializeComponent();
            ...
            if (b3 == 1)
                ...
                ck1.Content = (rnd.Next(1, 1000).ToString());
            if (b3 == 2)
                ck2.Content = (b4).ToString();
            else
                ck2.Content = (rnd.Next(1, 1000).ToString());
            if (b3 == 3)
                ck3.Content = (b4).ToString();
            else
                ck3.Content = (rnd.Next(1, 1000).ToString());
            if (b3 == 4)
                ck4.Content = (b4).ToString();
            else
                ck4.Content = (rnd.Next(1, 1000).ToString());
        }
